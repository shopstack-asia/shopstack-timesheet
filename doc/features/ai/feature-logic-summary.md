...
| [Semantic Pending-Response Extraction.md](./features/Semantic%20Pending-Response%20Extraction.md) | Owned pending → semantic confirm/cancel/correction; deterministic enforcement; no phrase-list write auth |
